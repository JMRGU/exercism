defmodule RemoteControlCar do
  ...
  def new(nickname) do
    # Feedback recommends providing a default value
    # new(nickname \\ "none"): Gives warning: this clause for new/0 cannot match because a previous clause at line 4 always matches
    # You can't win!
